...
//   selectedImage = id => {
//     const {randomImage, time} = this.state
//     if (id === randomImage.id && time !== 0) {
//       this.setState(prevState => ({
//         score: prevState.score + 1,
//       }))
//       const randomNumber = Math.floor(Math.random() * imagesList.length)
//       this.setState({randomImage: imagesList[randomNumber]})
//     } else if (id !== randomImage.id || time === 0) {
//       clearInterval(this.timerID)
...
//   render() {
//     const {activeTabId, randomImage, time, score, gameIsRunning} = this.state
...
//           style={{display: gameIsRunning ? 'block' : 'none'}}
//         >
...
//           style={{display: gameIsRunning ? 'none' : 'block'}}
//         >
//           <img
...
//           <p>YOUR SCORE</p>
//           <p>{score}</p>
//           <button type="button" onClick={this.gameReset}>
//             <img
